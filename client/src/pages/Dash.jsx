      ...
      <h1 className='text-3xl font-semibold text-center my-7'>Profile</h1>
        ...
        <div className="flex justify-between mt-5">
         ...
         {userListings.map((listing)=> (
          <div  key={listing._id} className="border rounded-lg p-3 flex justify-between item-centre gap-4">
            <Link to={`/listing/${listing._id}`}>
            <img src={listing.imageUrls[0]} alt='Listing Covers' className='h-16 w-16 object-contain rounded-lg'/>
            </Link>
            <Link  className="text-slate-700 font-sembold  hover:underline truncate flex-1"to={`/listing/${listing._id}`}>
            <p>{listing.name}</p>
            </Link>
